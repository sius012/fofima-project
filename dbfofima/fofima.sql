...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Sep 2021 pada 07.07
...
CREATE TABLE `buku_besar` (
  ...
  `keterangan-transaksi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Struktur dari tabel `nomor_perkiraan`
--

CREATE TABLE `nomor_perkiraan` (
  `nmr-perkiraan` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `nomor_perkiraan`
--

INSERT INTO `nomor_perkiraan` (`nmr-perkiraan`, `keterangan_nomor`, `kode_kategori`) VALUES
('1001', 'Kas SMK', '1000'),
